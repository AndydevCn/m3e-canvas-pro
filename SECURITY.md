...
straight to the provider you chose (OpenAI, Anthropic, Google, DeepSeek or Xiaomi
MiMo) and nothing else. The key is kept in this browser's local storage under `m3e:ai` and
