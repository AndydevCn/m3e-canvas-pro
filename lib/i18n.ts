...
export const UI = {
  ...
  saveSaving: { ja: "Saving…", en: "Saving…", zh: "保存中…" },
  savedTo: { ja: "Saved to", en: "Saved to", zh: "已保存到" },
  saveBrowser: { ja: "Saved in this browser", en: "Saved in this browser", zh: "保存在此浏览器" },
  saveLinkFile: { ja: "Link a file", en: "Link a file", zh: "连接到文件" },
  saveRestore: { ja: "Restore autosave", en: "Restore autosave", zh: "恢复自动保存" },
  saveLinked: { ja: "Autosave now writes to design.json", en: "Autosave now writes to design.json", zh: "自动保存已连接到 design.json" },
  saveLinkFailed: { ja: "Could not link a file", en: "Could not link a file", zh: "未能连接到文件" },
  saveFailed: { ja: "Could not save. Export the project by hand", en: "Could not save. Export the project by hand", zh: "保存失败，请手动导出项目" },
  saveQuota: { ja: "Browser storage is full. Link a file to keep saving", en: "Browser storage is full. Link a file to keep saving", zh: "浏览器存储已满，请连接到文件继续保存" },
  savePermission: { ja: "The file needs your permission again", en: "The file needs your permission again", zh: "需要重新授权该文件" },
  saveDisk: { ja: "このパソコンに保存しました", en: "Saved on this computer", zh: "已保存到本机磁盘" },
  projects: { ja: "プロジェクト", en: "Projects", zh: "项目" },
  newProject: { ja: "新しいプロジェクト", en: "New project", zh: "新建项目" },
  projectName: { ja: "プロジェクト名", en: "Project name", zh: "项目名称" },
  switchProject: { ja: "プロジェクトを切り替える", en: "Switch project", zh: "切换项目" },
  renameProject: { ja: "名前を変更", en: "Rename", zh: "重命名" },
  deleteProject: { ja: "プロジェクトを削除", en: "Delete project", zh: "删除项目" },
  deleteProjectAsk: { ja: "このプロジェクトを削除しますか？", en: "Delete this project?", zh: "删除这个项目？" },
  deleteProjectBody: {
    ja: "このプロジェクトとバックアップ 5 件が削除されます。元に戻せません。",
    en: "The project and its five backups are deleted. This cannot be undone.",
    zh: "该项目及其 5 份备份会被删除，且无法撤销。",
  },
  untitled: { ja: "無題", en: "Untitled", zh: "未命名" },
  /** the name given to a canvas this browser already had, when it becomes a project */
  importedDesign: { ja: "取り込んだデザイン", en: "Imported design", zh: "导入的设计" },
  copyFailed: { ja: "コピーできませんでした", en: "Could not copy", zh: "复制失败" },
  takeOver: { ja: "編集権を取得", en: "Take over editing", zh: "接管编辑权" },
  takeOverDone: { ja: "編集権を取得しました", en: "You are editing now", zh: "已接管编辑权，其他标签页已变为只读" },
  takeOverForced: {
    ja: "強制的に取得しました。別のタブが編集中の可能性があります",
    en: "Taken over by force; another tab may still be editing",
    zh: "已强制接管，另一个标签页可能仍在编辑",
  },
...
export const KO: Record<UIKey, string> = {
  ...
  saveSaving: "Saving…",
  savedTo: "Saved to",
  saveBrowser: "Saved in this browser",
  saveLinkFile: "Link a file",
  saveRestore: "Restore autosave",
  saveLinked: "Autosave now writes to design.json",
  saveLinkFailed: "Could not link a file",
  saveFailed: "Could not save. Export the project by hand",
  saveQuota: "Browser storage is full. Link a file to keep saving",
  savePermission: "The file needs your permission again",
  saveDisk: "이 컴퓨터에 저장됨",
  projects: "프로젝트", newProject: "새 프로젝트", projectName: "프로젝트 이름", switchProject: "프로젝트 전환",
  renameProject: "이름 바꾸기", deleteProject: "프로젝트 삭제", deleteProjectAsk: "이 프로젝트를 삭제할까요?",
  deleteProjectBody: "프로젝트와 백업 5개가 함께 삭제되며 되돌릴 수 없습니다.",
  untitled: "제목 없음", importedDesign: "가져온 디자인", copyFailed: "복사하지 못했습니다",
  takeOver: "편집 권한 가져오기", takeOverDone: "편집 권한을 가져왔습니다. 다른 탭은 읽기 전용이 됩니다",
  takeOverForced: "강제로 가져왔습니다. 다른 탭이 아직 편집 중일 수 있습니다",
